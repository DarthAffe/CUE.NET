...
namespace CUE.NET.Devices.MemoryModule
{
    ...
    /// </summary>
    public class CorsairMemoryModule : AbstractCueDevice
    {
        ...
        /// </summary>
        public CorsairMemoryModuleDeviceInfo MemoryModuleDeviceInfo { get; }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CorsairMemoryModule"/> class.
        /// </summary>
        /// <param name="info">The specific information provided by CUE for the headset stand</param>
        internal CorsairMemoryModule(CorsairMemoryModuleDeviceInfo info)
            : base(info)
        {
            this.MemoryModuleDeviceInfo = info;
        }
